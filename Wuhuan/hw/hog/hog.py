...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    score1 = player_score % 10
    score2 = opponent_score // 10 % 10
    score = abs(score1 - score2) * 3
    return score or 1
    # END PROBLEM 2
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def roll(player_score, opponement_score):
        return n
    return roll
    # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    "*** YOUR CODE HERE ***"
    maxi = 1
    fun = make_averaged(roll_dice, samples_count)
    maxn = fun(1, dice)
    for i in range(2, 11):
        n = fun(i, dice)
        if n > maxn:
