def berry_finder(t):
    ...
    if label(t) == "berry":
        ...
        return False or True in [berry_finder(i) for i in branches(t)]
...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    if label(t) == "loki" and is_leaf(t):
        return tree(lokis_replacement, [replace_loki_at_leaf(i,lokis_replacement) for i in branches(t)])
    else:
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    city_tmp = make_city("None", lat, lon)
    distance1 = distance(city_a, city_tmp)
    distance2 = distance(city_b, city_tmp)
...
def dejavu(t, n):
    ...
    if is_leaf(t):
        ...
        return True in [dejavu(i, n - label(t)) for i in branches(t)]
